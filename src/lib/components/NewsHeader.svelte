    ...
    <div class="container mx-auto px-4 py-4">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 w-full lg:w-auto">
                ...
                <!-- Local Time -->
                {#if mounted}
                    <div class="hidden lg:flex items-center gap-2 px-3 py-2 bg-muted/30 rounded-lg flex-shrink-0">
                        ...
                        {#if showUserMenu}
                            <div class="absolute right-0 mt-2 w-56 bg-card border border-border rounded-lg shadow-lg z-50">
                                ...
                                <div class="py-2">
                                    ...
                                    <a href="/profile/bookmarks" class="flex items-center gap-3 px-3 py-2 text-sm hover:bg-muted/50 transition-colors">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="/profile/reading-history" class="flex items-center gap-3 px-3 py-2 text-sm hover:bg-muted/50 transition-colors">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="/profile/settings" class="flex items-center gap-3 px-3 py-2 text-sm hover:bg-muted/50 transition-colors">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
